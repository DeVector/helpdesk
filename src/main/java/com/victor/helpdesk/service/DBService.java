...
public class DBService {
    ...
    public void instaciaDB(){
        Tecnico tecnic01 = new Tecnico("Luiz Bezerra", "52628197537", "bezerra@mail.com", "123");
        tecnic01.addPerfis(Perfil.ADMIN);

        Cliente cliente01 = new Cliente("Thomas Oliveira", "02987122454", "oliveira@mail.com", "123");
